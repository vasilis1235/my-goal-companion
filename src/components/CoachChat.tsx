...
const WELCOME: Msg = {
  role: "assistant",
  content:
    "👋 **Καλώς ήρθες στο WeightCoach!** Είμαι ο AI προπονητής σου.\n\nΜπορώ να σε βοηθήσω:\n- Να **καταγράψεις** το βάρος σου\n- Να **ορίσεις στόχο** ρεαλιστικό για εσένα\n- Με **συμβουλές** για διατροφή, άσκηση & κίνητρο\n\nΠες μου, πώς νιώθεις σήμερα; 💪",
};
